...
AppName=Maritime ERP System
AppVersion=1.0.0
AppVerName=Maritime ERP System 1.0.0
...
DefaultDirName={autopf}\Maritime ERP System
DisableProgramGroupPage=yes
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
OutputDir=Installer
OutputBaseFilename=MaritimeERP_Setup_v1.0.0
...
Source: "src\MaritimeERP.Desktop\bin\Release\net8.0-windows\maritime_erp.db"; DestDir: "{app}\Database"; Flags: ignoreversion; Check: not FileExists(ExpandConstant('{userappdata}\Maritime ERP System\Database\maritime_erp.db'))
...
[Icons]
Name: "{autoprograms}\Maritime ERP System"; Filename: "{app}\MaritimeERP.Desktop.exe"
Name: "{autodesktop}\Maritime ERP System"; Filename: "{app}\MaritimeERP.Desktop.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Maritime ERP System"; Filename: "{app}\MaritimeERP.Desktop.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\MaritimeERP.Desktop.exe"; Description: "{cm:LaunchProgram,Maritime ERP System}"; Flags: nowait postinstall skipifsilent

[Dirs]
Name: "{userappdata}\Maritime ERP System\Database"; Permissions: users-full
Name: "{userappdata}\Maritime ERP System\Documents"; Permissions: users-full
Name: "{userappdata}\Maritime ERP System\Logs"; Permissions: users-full
...
begin
  ...
  begin
    ...
    DestPath := ExpandConstant('{userappdata}\Maritime ERP System\Database\maritime_erp.db');
...
begin
  UserConfigPath := ExpandConstant('{userappdata}\Maritime ERP System\appsettings.json');
  
  if not FileExists(UserConfigPath) then
  begin
    ConfigContent := '{' + #13#10 +
      '  "ConnectionStrings": {' + #13#10 +
      '    "DefaultConnection": "Data Source=' + ExpandConstant('{userappdata}\Maritime ERP System\Database\maritime_erp.db') + '"' + #13#10 +
      '  },' + #13#10 +
      '  "Logging": {' + #13#10 +
      '    "LogLevel": {' + #13#10 +
      ...
      '  },' + #13#10 +
      '  "Application": {' + #13#10 +
      '    "Name": "Maritime ERP System",' + #13#10 +
      '    "Version": "1.0.0",' + #13#10 +
      '    "CompanyName": "Maritime Solutions",' + #13#10 +
      '    "DocumentStoragePath": "' + ExpandConstant('{userappdata}\Maritime ERP System\Documents') + '",' + #13#10 +
